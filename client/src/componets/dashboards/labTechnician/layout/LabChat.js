...
export default function LabChat() {
  ...
  return (
    <div>
      ...
      <main className="labChatDashboard ">
        <div className="labChatDashboardFirstCard">
          <div className="labChatDashboardNavBarContainer">
            <div>
              <FontAwesomeIcon
                icon={faBars}
            ...
            <div className="labChatDashboardLogOutContainer">
        ...
        <div className="labChatDashboardSecondCard">
