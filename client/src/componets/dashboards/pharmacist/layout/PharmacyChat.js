...
import "../styles/PharmacyChat.css";
// Fontawesome family
...
export default function PharmacyChat() {
  ...
  return (
    <div>
      ...
      <main className="pharmacyChatDashboard ">
        <div className="pharmacyChatDashboardFirstCard">
          <div className="pharmacyChatDashboardNavBarContainer">
            <div>
              <FontAwesomeIcon
                icon={faBars}
            ...
            <div className="pharmacyChatDashboardLogOutContainer">
        ...
        <div className="pharmacyChatDashboardSecondCard">
          <Toaster position="top-center" reverseOrder={false}></Toaster>
          <div>
            <MultiChatWindow
              {...chatProps}
              style={{ height: "90vh", fontSize: "17px", padding: "10px" }}
            />
            <MultiChatSocket
              {...chatProps}
              style={{ height: "90vh", fontSize: "22px" }}
            />
          </div>
        </div>
      </main>
