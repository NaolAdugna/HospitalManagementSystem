      ...
      <div className="footerContainer">
        <div className="footerLogoContainer">
          ...
          <p>
            ...
            South West Ethiopia regional state. It’s located in the south
            western part of Ethiopia, particularly in Bonga, which is the
            capital city of South West Ethiopia regional state.
          </p>
        ...
        <div className="footerAddressContainer">
          ...
          <div className="footerEmailContent">
            <FontAwesomeIcon
              ...
              className="iconAddress iconaddress3"
            />
            <h4 style={{ fontWeight: "500" }}>example@gmail.com</h4>
          </div>
        </div>
      </div>
